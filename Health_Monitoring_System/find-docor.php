      ...
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <div class="form-group">
            ...
            <input type="email" name="doc-email" id="" class="form-control" placeholder=" Doctor Email" autocomplete="off">
          </div>
        
          <div class="form-group">
            <label class="control-label">User Email:<span class="text-danger">*</span></label>
            <input type="email" name="user-email" id="" class="form-control" placeholder="User Email" autocomplete="off">
            <span id='message'></span>
          </div>
          <div class="form-group">
            <label class="control-label">Massage: <span class="text-danger">*</span></label>
            <textarea id="" name="massage" rows="4" cols="50" class="form-control">
