...
if ($TEMPERATURE==$temp_n || $TEMPERATURE<=99  ) {
	...
	echo '<div class="alert-success text-success"><br>
	<h4 class="text-primary"> Temperature Medicine list :</h4>

	<h6 class="text-success"> No need to take any medicine! Your temperature is Normal </h6><br>
...
<div class="tile">
	<h3>Sugestion Doctor List</h3><hr>
		...
		<table class="table table-hover table-bordered"   align=center>
			...
			<tbody>
				<tr>
					<td class="text-danger">Nozrul islam</td>
					<td>medicine</td>
					<td>Dhaka,boshundhora</td>
					<td>4pm-9pm</td>
					<td><a href="#">Take Appointment</a></td>
				</tr>
				<tr>
					<td class="text-danger">Tanveer islam</td>
					<td>medicine</td>
					<td>Mymensingh</td>
					<td>12pm-5pm</td>
					<td><a href="#">Take Appointment</a></td>
