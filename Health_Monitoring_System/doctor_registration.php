...
$stmt = $dbh->prepare("INSERT INTO `doctor_registration`(`name`,`email`,`mobile`,`specialist`,`doctortype`,`password`,`image`) VALUES (:name, :email, :mobile,:specialist, :doctortype, :password, :image)");
...
$stmt->bindParam(':doctortype', $doctortype);
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box2">
        ...
        <form action="doctor_registration.php" method="post" class="login-form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label class="control-label">Specialist<span class="text-danger">*</span></label>
            <input type="tel" name="specialist" id="" class="form-control" placeholder="Specialist" autocomplete="off">
          </div>
           <div class="form-group">
            <label class="control-label">Doctor Type<span class="text-danger">*</span></label>
            <input type="tel" name="doctortype" id="" class="form-control" placeholder="Doctor type" autocomplete="off">
          </div>
